...
| --- | --- | --- |
| `fraunces-variabel.woff2` | Fraunces | SIL Open Font License 1.1 — Undercase Type |
| `newsreader-variabel.woff2` | Newsreader | SIL Open Font License 1.1 — Production Type |
| `plex-mono-400.woff2` | IBM Plex Mono | SIL Open Font License 1.1 — IBM |
| `plex-mono-500.woff2` | IBM Plex Mono | SIL Open Font License 1.1 — IBM |

Opgehaald op 2026-08-12 via de Google Fonts API,
