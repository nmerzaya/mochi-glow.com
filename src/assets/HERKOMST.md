...
- **Stijlversie:** 4. Eén vaste stijlzin voor alle beelden, zodat de
...
- **Belichting op selectie:** per beeld wordt de gemiddelde helderheid gemeten
  (Rec. 709). Valt die buiten 100-185, dan wordt het
  onderwerp opnieuw opgevraagd met een ander zaad, tot 3
  ...
  Bij deze run zijn 1 beelden opnieuw opgevraagd en bleven er 0 buiten de band.

## Beelden (84)

| Bestand | Rol | Onderwerp | Afmeting | Datum |
| --- | --- | --- | --- | --- |
| `centella-asiatica.jpg` | hero | a cluster of round pennywort leaves with scalloped edges, still wet with dew, on pale damp stone | 1024×576 → 2048×1152 | 2026-08-12 |
...
| `pdrn-3.jpg` | in de tekst | a twisted translucent ribbon of gel coiled like a helix on pale wet stone | 1024×576 → 2048×1152 | 2026-08-12 |
| `propolis.jpg` | hero | a broken fragment of honeycomb with warm amber resin in the cells, lit from behind against a bright bone-white background | 1024×576 → 2048×1152 | 2026-08-12 |
| `propolis-2.jpg` | in de tekst | raw propolis chunks, waxy and amber, in a small pale carved wooden bowl | 1024×576 → 2048×1152 | 2026-08-12 |
...
| `snail-mucin.jpg` | hero | a glossy spiral shell seen from directly above on pale wet stone | 1024×576 → 2048×1152 | 2026-08-12 |
| `snail-mucin-2.jpg` | in de tekst | macro of a clear viscous trail across pale grey glass, catching a thin line of light | 1024×576 → 2048×1152 | 2026-08-12 |
| `snail-mucin-3.jpg` | in de tekst | damp green leaves in soft even daylight with water beading on the surface | 1024×576 → 2048×1152 | 2026-08-12 |
| `vitamine-c.jpg` | hero | a citrus cross-section, macro, pulp segments translucent, lit from behind against a bright bone-white background | 1024×576 → 2048×1152 | 2026-08-12 |
...
| `groene-thee.jpg` | hero | fresh green tea leaves, macro, still wet from rain, on pale grey stone | 1024×576 → 2048×1152 | 2026-08-12 |
...
| `ginseng.jpg` | hero | a whole ginseng root with fine pale tendrils lying on pale linen, macro | 1024×576 → 2048×1152 | 2026-08-12 |
...
| `bijvoet-3.jpg` | in de tekst | a herbal infusion in a shallow pale stone bowl with steam lifting off it | 1024×576 → 2048×1152 | 2026-08-12 |
| `houttuynia-cordata.jpg` | hero | heart-shaped houttuynia leaves wet with rain, macro, against pale grey stone | 1024×576 → 2048×1152 | 2026-08-12 |
| `houttuynia-cordata-2.jpg` | in de tekst | houttuynia leaves in soft even daylight, shallow focus, pale background | 1024×576 → 2048×1152 | 2026-08-12 |
...
| `gefermenteerde-soja-3.jpg` | in de tekst | fermented soybean paste in a pale ceramic dish, thick textured surface | 1024×576 → 2048×1152 | 2026-08-12 |
...
| `darm-huid-as-3.jpg` | in de tekst | macro of a fern frond unfurling, lit from behind against a bright bone-white background | 1024×576 → 2048×1152 | 2026-08-12 |
...
| `darmmicrobioom-en-huidmicrobioom-3.jpg` | in de tekst | close-up of forearm skin texture in soft raking light, fine detail | 1024×576 → 2048×1152 | 2026-08-12 |
...
| `suiker-en-glycatie.jpg` | hero | white sugar crystals spilled across pale grey stone, extreme macro | 1024×576 → 2048×1152 | 2026-08-12 |
| `suiker-en-glycatie-2.jpg` | in de tekst | pale caramel in a pan, close-up of the surface catching light | 1024×576 → 2048×1152 | 2026-08-12 |
